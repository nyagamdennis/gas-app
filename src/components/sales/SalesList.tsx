        ...
        {sales.map((sale) => {
          ...
          return (
            <div
              ...
              } ${hasDeficits ? "border-l-4 border-red-400 bg-red-50/30" : ""}`}
            >
              {/* Sale Header - Mobile Optimized */}
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <span className="font-bold text-blue-700 text-sm sm:text-base truncate max-w-[120px] sm:max-w-none">
                      ...
                      {/* Deficit Badges */}
                      {hasDeficits && saleDeficits.length === 1 && (
                      ...
                      <div className="ml-2 flex items-center">
                        {sale.payments?.[0]?.payment_method === "CASH" ? (
                          <span className="px-1.5 py-0.5 bg-green-100 text-green-800 rounded text-[10px] flex items-center">
                            <Payment fontSize="inherit" className="mr-0.5" />
                        ...
                        {sale.payments.map((payment, index) => (
                          ...
                          >
                            <div className="flex items-center">
                              ...
                              >
                                {payment.payment_method === "CASH" ? "C" : "M"}
                              </div>
                              <div>
