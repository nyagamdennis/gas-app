    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
                ...
                <div className="max-w-4xl mx-auto mb-6">
                    <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 pb-4 border-b border-gray-200">
                            <div>
                                <p className="text-sm font-semibold text-gray-700">From Location</p>
                                <p className="text-gray-600">
                                    {receiptData.receipt.from_shop_name || receiptData.receipt.from_location_name}
                                </p>
                            ...
                            <div>
                                <p className="text-sm font-semibold text-gray-700">To Location</p>
                                <p className="text-gray-600">
                                    {receiptData.receipt.to_store_name || receiptData.receipt.to_location_name}
                                </p>
                                <p className="text-xs text-gray-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <p className="text-gray-600">
                                    <span className="font-semibold">Transferred By:</span> {receiptData.receipt.transferred_by_name}
                                </p>
                                <p className="text-gray-600">
                                    <span className="font-semibold">Transfer Date:</span> {new Date(receiptData.receipt.transfer_date).toLocaleString()}
                                </p>
                            </div>
            ...
            <div className="max-w-4xl mx-auto">
                <h2 className='text-center font-bold text-2xl text-gray-800 mb-6'>Empty and Spoiled Cylinders Returns</h2>

                {/* Transferred Items Summary */}
                {receiptData?.transferred_items && receiptData.transferred_items.length > 0 && (
                    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                        <h3 className="text-lg font-bold text-gray-800 mb-4">Transfer Summary</h3>
                        <div className="grid grid-cols-1 gap-4">
                            {receiptData.transferred_items.map((item, index) => (
                                ...
                                >
                                    <div>
                                        <p className="font-semibold text-gray-800">{item.cylinder}</p>
                                        <p className="text-sm text-gray-600">
                                            Empty: <span className="font-bold">{item.empty_quantity}</span>
                                            {item.spoiled_quantity > 0 && (
                                                <>
                                                    {" | "}Spoiled: <span className="font-bold">{item.spoiled_quantity}</span>
                                                </>
                                            )}
                                        </p>
                                    </div>
                ...
                {receiptData?.receipt?.items && receiptData.receipt.items.length > 0 && (
                    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                        <h3 className="text-lg font-bold text-gray-800 mb-4">Detailed Items</h3>
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="bg-gray-100 border-b-2 border-gray-300">
                                        <th className="px-4 py-2 text-left font-bold">Item Name</th>
                                        <th className="px-4 py-2 text-center font-bold">Full</th>
                                        <th className="px-4 py-2 text-center font-bold">Empty</th>
                                ...
                                <tbody>
                                    {receiptData.receipt.items.map((item, index) => (
                                        <tr key={index} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="px-4 py-2 text-center">{item.full_quantity}</td>
