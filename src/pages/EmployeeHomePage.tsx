      ...
      {isMobile ? (
        <div className="min-h-screen bg-gradient-to-br from-[#f1f5f9] to-[#e2e8f0] text-gray-800 flex flex-col font-sans">
          ...
          <main className="m-2 p-1 grid grid-cols-3 gap-4">
            ...
            >
              <FactCheckIcon className="text-blue-600" fontSize="large" />
              <p className="mt-2 text-sm font-semibold text-blue-700 text-center">
                Record Sales
              </p>
            </Link>
            <Link to={"/salesteamcylinders"} className="bg-gradient-to-br from-green-50 to-green-100 flex flex-col items-center justify-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow aspect-square">
              <GasMeterIcon className="text-green-600" fontSize="large" />
              <p className="mt-2 text-sm font-semibold text-green-700 text-center">
                Cylinders
              </p>
            </Link>
            <Link to={"/otherproducts"} className="bg-gradient-to-br from-yellow-50 to-yellow-100 flex flex-col items-center justify-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow aspect-square">
              <MicrowaveIcon className="text-yellow-600" fontSize="large" />
              <p className="mt-2 text-sm font-semibold text-yellow-700 text-center">
                Other Products
              </p>
            </Link>
            <Link to={"/teamsales"} className="bg-gradient-to-br from-red-50 to-red-100 flex flex-col items-center justify-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow aspect-square">
