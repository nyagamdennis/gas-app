        ...
        try {
          ...
          if (is_admin) {
            if (isLargeScreen) {
              ...
              navigate("/admins", { state: { message: "Welcome, Admin!" } })
            }
          } else if (has_employee_profile && !is_verified) {
            navigate("/myprofile", {
              state: {
                message:
                  "Your profile is not verified. Please contact the admin.",
              },
            })
          } else if (!has_employee_profile) {
            navigate("/createprofile", {
              state: {
                message: "Please create your employee profile to continue.",
              },
            })
          } else {
