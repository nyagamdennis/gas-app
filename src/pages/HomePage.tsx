...
import {
  fetchSalesTeamManagement,
  getSalesTeamManagementStatus,
  selectAllSalesTeamManagement,
} from "../features/salesTeam/salesTeamManagementSlice"
...
const HomePage = () => {
  ...
  const handleChangeTeams = () => {
    dispatch(
      changeSalesTeamMember({ userId: employeeId, teamsId: selectedTeamId }),
    )
  }
                            ...
                            <div className=" px-2 ">
                              ...
                              {team.employees.map(
                                (employee: any, index: any) => (
                                  <p
                                    key={employee.id}
                                    className=" font-semibold text-white flex justify-between space-x-2 items-center"
                                  >
                                    <div>
                                      {index + 1}. {employee.first_name}{" "}
                                      {employee.last_name} +254 {employee.phone}
                                    </div>
                                    <div>
                                      <RemoveIcon
                                        onClick={() =>
                                        ...
                                        className=" cursor-pointer border border-solid !h-4 !w-4"
                                      />
                                    </div>
                                  </p>
                                ),
                      ...
                      <div>
                        <TableContainer component={Paper}>
                          ...
                          >
                            ...
                            <TableBody>
                              {Object.entries(
                                groupCylindersByGasType(
                                  team.assigned_cylinders,
                                ),
                              ).map(([gasType, cylinders], gasTypeIndex) => (
                                <React.Fragment key={gasTypeIndex}>
                                  {/* Render the first row with the gas type */}
                                  <TableRow>
                                    {/* // @ts-ignore */}
                                    <TableCell
                                      rowSpan={cylinders.length}
                                      className="font-bold"
                                    >
                                      {gasType}
                                    </TableCell>
                                    {/* @ts-nocheck */}
                                    <TableCell align="center">
                                      {cylinders[0].cylinder_details.weight} kg
                                    </TableCell>
                                    <TableCell align="center">
                                      {cylinders[0].assigned_quantity}
                                    </TableCell>
                                    <TableCell align="center">
                                      {cylinders[0].filled}
                                    </TableCell>
                                    ...
                                    <TableCell align="center">
                                      {cylinders[0].wholesale_refilled}
                                    </TableCell>
                                    <TableCell align="center">
                                      {cylinders[0].wholesale_sold}
                                    </TableCell>
                                    <TableCell align="center">
                                      {cylinders[0].retail_refilled}
                                    </TableCell>
                                    <TableCell align="center">
                                      {cylinders[0].retail_sold}
                                    </TableCell>
                                    <TableCell align="center">
                                  ...
                                  {cylinders
                                    .slice(1)
                                    .map((cylinder, cylinderIndex) => (
                                      <TableRow key={cylinderIndex}>
                                        <TableCell align="center">
                                          {cylinder.cylinder_details.weight} kg
                                        </TableCell>
                                        <TableCell align="center">
        ...
        <DialogContent>
          <div className=" flex flex-col space-y-2">
            <h4
              ...
              className=" border-b border-gray-500 cursor-pointer hover:bg-gray-400"
            >
              Transfer to deferent sales team.
            </h4>
            <h4 className="border-b border-gray-500 cursor-pointer hover:bg-gray-400">
              Suspend.
            </h4>
            <h4 className="border-b border-gray-500 cursor-pointer hover:bg-gray-400">
              Fire employee.
            ...
            {allSalesTeam
              ...
              .map((team) => (
                ...
                <h2
                  ...
                  className=" text-lg text-center cursor-pointer border-b"
                >
                  {team.name}
                </h2>
              ))}
