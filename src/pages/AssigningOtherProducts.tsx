...
const AssigningOtherProducts = () => {
    ...
    const handleAssign = () => {
        ...
        dispatch(assignOthers(payload))
            .then(() => navigate(`/admins/afterassignothers/${selectedTeam?.id}`, { state: { salesTeamName: selectedTeam?.name } }))
                            ...
                            <tbody>
                                {products.map((product) =>
                                    <tr key={product.id}>
                                        ...
                                        <td className="border px-2 py-1 text-center"><FormattedAmount amount={product.retail_sales_price} /></td>
                                        <td className="border px-2 py-1 text-center"><FormattedAmount amount={product.whole_sales_price} /> </td>
