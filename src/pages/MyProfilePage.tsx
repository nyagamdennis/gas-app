...
const MyProfilePage = () => {
  ...
  return (
    <div className="min-h-screen min-w-full bg-gray-50 flex flex-col">
      {/* Header */}
      <main className="">
      <EmployeeNav headerMessage={myProfile.sales_team?.name || "No Sales Team Assigned"} headerText={'Manage your profile.'} myProfile={myProfile} />
        ...
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-md p-6 space-y-6">
          ...
          <div className="border border-dashed border-green-800 rounded-md p-4 bg-green-50">
            <h4 className="text-md font-bold text-green-900 mb-1">
              Net Salary
            </h4>
