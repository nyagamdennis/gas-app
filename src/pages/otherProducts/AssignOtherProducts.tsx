              ...
              {!selectedTeam ? (
                ...
                <div>
                  <h2 className="text-xl font-bold text-center mb-4">
                    Assign products to {selectedTeam.name}
                  </h2>
                  <div>
                    <table className="mt-2 w-full border text-sm">
                      <thead>
                        <tr className="bg-gray-200 text-left">
                          ...
                          <th className="border px-1 py-1">Retail Price</th>
                          <th className="border px-1 py-1">Wholesale Price</th>
                          <th className="border px-1 py-1">Assign</th>
                        </tr>
                      </thead>
                      <tbody>
...
export default AssignOtherProducts
