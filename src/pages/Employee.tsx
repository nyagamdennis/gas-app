...
const Employee = () => {
  ...
  const handleSalesTeamChange = async (employeeId) => {
    ...
    try {
      await dispatch(
        transferEmployee({ employeeId, salesTeamId: newSalesTeam }),
      ).unwrap()
                      ...
                      <td className="px-4 py-2 space-x-1 flex">
                        <button
                          ...
                          className={`px-2 py-1 rounded ${
                            employee.verified ? "bg-green-500" : "bg-gray-500"
                          }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-2 py-1 rounded ${
                            employee.suspended ? "bg-red-500" : "bg-yellow-500"
                          }`}
                        >
                        ...
                        <button
                          onClick={() =>
                            handleStatusChange(employee.id, "fired")
                          }
                          className={`px-2 py-1 rounded ${
                            employee.fired ? "bg-red-700" : "bg-blue-500"
                          }`}
                        >
                        ...
                        <button
                          onClick={() =>
                            handleStatusChange(employee.id, "defaulted")
                          }
                          className={`px-2 py-1 rounded ${
                            employee.defaulted
                              ? "bg-orange-500"
                      ...
                      <tr>
                        <td colSpan="6" className="p-4 bg-gray-700">
                          <div className="flex space-x-6">
                            <img
                              src={
                                employee.profile_image || "default_profile.jpg"
                              }
                              alt="Profile"
                              onClick={() =>
                                handleImageClick(employee.profile_image)
                              }
                            ...
                            <img
                              ...
                              alt="Front ID"
                              onClick={() =>
                                handleImageClick(employee.front_id)
                              }
                              className="w-24 h-24 rounded-md border cursor-pointer hover:scale-110 transition"
                            />
                            <img
                          ...
                          <div className="mt-4">
                            ...
                            <p>
                              ...
                              {employee.alternative_phone || "N/A"}
                            </p>
                          </div>
                        </td>
                      </tr>
